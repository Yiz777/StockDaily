...
"site:federalreserve.gov FOMC statement projections [TODAY]"
"site:investor.wdc.com news release [TODAY or past 72 hours]"
"site:unitedhealthgroup.com newsroom investors [TODAY or past 72 hours]"
...
### 新闻质量闸门（2026-09-17 修复，必须逐条通过）

「新闻翻译官」只收录**真实发生、能改变判断或解释当日价格的独立事件**，不能为了凑数量把行情数字、日历提醒或无原因异动包装成新闻。

每条新闻必须同时具备：

1. **可点击的原始标题**：链接直达报道、监管文件或公司公告，不链接搜索结果页。
2. **来源 + 发布时间**：交易日优先过去 36 小时；周末/休市可放宽到 72 小时，并注明日期。
3. **事实**：用一句大白话说明究竟发生了什么，不把推测写成事实。
4. **为什么今天重要**：必须落到 VOO / QQQ / SCHD / WDC / MCD / UNH、现金节奏或明确触发线；没有影响就不收录。
5. **来源质量**：宏观政策优先 Federal Reserve / BLS / BEA；公司事件优先 IR / SEC；市场反应优先 Reuters / AP。二手转载只有在找不到一手来源时才使用。

以下内容**不能单独计为有效新闻**：

- 指数或个股涨跌本身（应放市场温度计/持仓速览）
- 财报发布日期、经济数据日历（应放本周关注/持仓预警）
- 找不到原因的盘后波动
- KOL常识、旧观点、没有当天新发言的“方法论”
- 公司赞助调查或营销稿；若确有持仓相关性，必须标注“公司赞助/营销材料”，且不能作为买入或卖出证据

目标是 3–5 条高质量新闻。若当天只能核验 2 条，就明确写“今天仅核验到 2 条有效新闻”，**宁缺毋滥，不得用无效内容补足 3 条**。

如果 FOMC 决议在未来 7 天内，或决议公布后 3 天内，必须把利率路径放进顶部「持仓预警/关键提醒」和「今日建议」，不能只埋在新闻翻译官里。必须写清：当前利率、市场预期/点阵图、对成长股与现金节奏的影响、下一次复核触发点。
...
| 7 | 新闻翻译官 | 📰 | **目标3–5条有效新闻；必须有标题、来源、时间、直链、持仓影响，宁缺毋滥** |
| 8 | 持仓速览 | 👜 | 蓝色背景，无账号股数 |
